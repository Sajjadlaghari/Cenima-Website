<?php 
   ...
   class database
   {
   	...
   	function insert($first_name,$last_name,$email,$password,$gender,$dob,$address,$path)
     {
      ...
      function insert_user($role,$name,$email,$phone_number,$password)
     {
         global $conn;
      ...
      function show_all_admin_information($user_id)
     {
      ...
      function payments_customer($id,$owener_name,$number,$expire,$ccv)
      {
         global $conn;
         $sql="INSERT INTO payments(movie_id,card_owner,card_number,expire_date,ccv )VALUES('".$id."','".$owener_name."','".$number."','".$expire."','".$ccv."')";
